...
class TaskHeader(models.Model):
    ...
    customer_type = models.CharField(max_length=500, choices=[('Existing Customer', 'Existing Customer'), ('New Customer', 'New Customer')])
    task_type = models.CharField(max_length=500, choices=[('New Order', 'New Order'), ('Payment', 'Payment'), ('Meeting Customer', 'Meeting Customer')])
